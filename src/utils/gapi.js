 ...
 */
    ...
    var Ba = function (a) {
            if (a instanceof t && a.constructor === t && a.ca === Aa)
                return a.P;
    ...
    var Da = function (a) {
        ...
        Fa = function (a) {
            ...
            ta(Ea.test(a), '%s does not match the safe URL pattern', a) ||
    ...
    var Ja = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
        Ka = (function (a) {
            var b = !1,
                c;
            return function () {
  ...
  gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var jb = function (a, b, c, d) {
        ...
        mb = function (a) {
            if (kb()) a();
                ...
                x.addEventListener
                    ? (x.addEventListener('load', c, !1),
                      x.addEventListener('DOMContentLoaded', c, !1))
                    : x.attachEvent &&
    ...
    var yb = function (a, b, c) {
        ...
        Ab = function (a, b, c) {
            b &&
                0 < b.length &&
                ((b = zb(b)),
                c && 0 < c.length && (b += '___' + zb(c)),
                28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
                (c = b),
                (b = A(xb, '_p', B())),
                (A(b, c, B())[a] = new Date().getTime()),
                yb(a, '_p', c));
        },
        zb = function (a) {
            return a
    ...
    var Cb = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Lb = function (a) {
            ...
            for (d = Db.length; c < d; ++c)
                Db[c].test(b) && O('invalid_prefix');
            c = Ob(a, 'k', !0);
            d = Ob(a, 'am');
            e = Ob(a, 'rs');
            a = Ob(a, 't');
            return { pathPrefix: b, version: c, S: d, Z: e, aa: a };
        },
        Mb = function (a) {
    ...
    var Qb = decodeURI('%73cript'),
        ...
        Tb = function () {
            var a = K.nonce;
            return void 0 !== a
                ? a && a === String(a) && a.match(Rb)
                    ? a
                    : (K.nonce = null)
                : z.querySelector
                ? (a = z.querySelector('script[nonce]'))
        ...
        Ub = function (a) {
            ...
            b.async = 'true';
            (a = z.getElementsByTagName(Qb)[0])
                ? a.parentNode.insertBefore(b, a)
                : (z.head || z.body || z.documentElement).appendChild(b);
        },
        Xb = function (a, b) {
            var c = b && b._c;
            if (c)
            ...
            if (e['::'] && b.length) {
                ...
                for (var f = null; (f = b.shift()); ) {
                    ...
                    var h = (a.length && a[a.length - 1]) || null,
                        k = h;
                    (h && h.hint == g) || ((k = { hint: g, V: [] }), a.push(k));
                    k.V.push(f);
                }
                var l = a.length;
                if (1 < l) {
    ...
    var vc =
        ...
        xc = function (a) {
            ...
            null == b &&
                ...
                (b = H(a, 'authuser') || null),
                null == b && (b = (b = a.match(vc)) ? b[1] : null));
    ...
    var zc,
        ...
        $c = function (a) {
            if (-1 !== S)
                return Yc(), T ? m.JSON.stringify.call(m.JSON, a) : W(a);
        },
        ad =
        ...
        zd = function (a, b, c, d, e) {
            ...
            try {
                document.all &&
                    (f = a.createElement(
                        '<iframe frameborder="' +
                            Wa(String(c.frameborder)) +
                            '" scrolling="' +
                            Wa(String(c.scrolling)) +
                            '" ' +
                            h +
                            ' name="' +
                            Wa(String(c.name)) +
            ...
            for (var k in c)
                (a = c[k]),
                    'style' === k && 'object' === typeof a
                        ? D(a, f.style)
                        : wd[k] || f.setAttribute(k, String(a));
            ...
            for (f = 0; f < e.length; f++) {
                ...
                h &&
                    (Xd[h] ||
                        ...
                        0 != Xa(Pd(g)).length) &&
                    (g.setAttribute('data-gapiscan', !0), A(c, h, []).push(g));
            }
            if (b)
                for (var r in c)
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        Ad.test(b) &&
                            ...
                            E(!!e, 'Unknown iframe url config for - ' + b));
                        ...
                        !n &&
                            r &&
                            ((r =
                                H(b.location.href, '_gfid', '') ||
                                H(b.location.href, 'id', '')),
                            (n = H(b.location.href, 'pfname', '')),
                            (n = r ? n + '/' + r : ''));
                        n ||
                            ((r = Zc(H(b.location.href, 'jcp', ''))) &&
                                'object' == typeof r &&
                                (n = (n = r.id) ? r.pfname + '/' + n : ''));
                        p.pfname = n;
    ...
    qe.prototype.read = function () {
        for (
            var a = this.L + '=', b = document.cookie.split(/;\s*/), c = 0;
            c < b.length;
            ++c
        ) {
            var d = b[c];
    ...
    var ye = function (a) {
            ...
            d = 'E' === c && e.i;
            return (!d && ('U' !== c || e.i)) || (d && !ue)
                ? b
                : { W: !0, i: d, ja: a.substr(1), domain: e.domain, l: e.l };
        },
        ze = function (a) {
            if (!a) return [];
            a = a.split('=');
            ...
            if (null !== a) {
                ...
                if (c) {
                    var d = Ae(c),
                        e = d && d.ia[Number(a)];
                    d = d && d.clientId;
                    if (e) return { F: a, ha: e, clientId: d };
                }
            }
            return null;
        };
